...
export default function CourseList() {
    ...
    const [filterCategories, setFilterCategories] = useState([] as any);
    const [filterRatingRange, setFilterRatingRange] = useState([] as any);
    const [filterInstractors, setFilterInstractors] = useState([] as any);
    ...
    const handleFilterInstractors = (item: any) => {
        if (filterInstractors.includes(item)) {
            const filtered = filterInstractors.filter((elm: any) => elm != item);
            setFilterInstractors([...filtered]);
        } else {
            setFilterInstractors((pre: any) => [...pre, item]);
        }
    };
    ...
    const handleFilterlanguange = (item: any) => {
        if (filterLanguage.includes(item)) {
            const filtered = filterLanguage.filter((elm: any) => elm != item);
            setFilterLanguage([...filtered]);
        } else {
            setFilterLanguage((pre: any) => [...pre, item]);
        }
    };
    const handleFilterDuration = (item: any) => {
                                                    ...
                                                    >
                                                        <div className="form-radio mr-10">
                                                            <div className="radio">
                                                                <input
                                                                    type="radio"
                                                                    checked={filterRatingRange.length < 1}
                                                                />
                                        ...
                                        <div className="col-xl-3 col-lg-4 col-sm-6">
                                            <div className="sidebar__item">
                                                ...
                                                <div className="sidebar-checkbox">
                                                    ...
                                                    {instructorNames.map((item, index) => (
                                                        <div
                                                            className="sidebar-checkbox__item cursor"
                                                            key={index}
                                                            onClick={() =>
                                                        ...
                                                        >
                                                            <div className="form-checkbox">
                                                                <input
                                                                    type="checkbox"
                                                                    checked={
                                                                        !!filterLanguage.includes(item.title)
                                                                    }
                                                                />
                                                                <div className="form-checkbox__mark">
                                                                    <div
